...
public interface UserRepository extends JpaRepository<ApplicationUser, Integer> {
     ...
     * @return
     */
    public List<ApplicationUser> findAllByEmailOrderByIdDesc(@Param("email") String email);
     ...
     * @return
     */
    public List<ApplicationUser> findAllByEmail(@Param("email") String email, Sort sort);
}
